  ...
  return (
    <header>
      <div className="header-wrapper">
        <h1 className="heading" onClick={handleHeaderClick}>
          Where in the world?
        </h1>
        <div className="theme-box">
          <div className="theme-icon-wrapper" onClick={handleThemeIconClick}>
            <div
              className={`theme-icon moon-icon ${
                props.darkMode ? "hidden" : ""
              }`}
            >
              <svg
                version="1.1"
          ...
          <p className="mode-text">{props.themeText}</p>
        </div>
      </div>
    </header>
  );
